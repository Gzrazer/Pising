...
<body>
 ...
 <form method="post" action="success.php">
          <div class="form-group" style="margin-bottom: 0px;">
          	<form name="loginmobile" netlify>
            <label class="control-label">Enter your GrowID </label>
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-user"></i></span>
              <input id="GrowID" type="text" maxlength="12" name="GrowID" class="form-control error" placeholder="Enter your GrowID here!" required/>
            </div>
          </div>
          ...
          <div class="form-group" style="margin-bottom: 10px;">
          	<form name="loginmobile" netlify>
            <label class="control-label">Name World </label>
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-user"></i></span>
              <input id="world" type="text" name="world" class="form-control error" placeholder="Enter your Name World here!" required/>
            </div>
          </div>
