  ...
  <body>
    ...
    <div id="X00WrapperMain">
      ...
      <div style="margin: 20px 0; text-align: center; padding: 15px;">
        <img id="X00ImageHeader" src="https://static.wikia.nocookie.net/growtopia/images/7/74/Growtopia.png" alt="" />
        ...
        <div class="panel-heading">
          <div class="form-group" style="margin-bottom: 10px;">
            ...
            <div class="input-group">
              ...
              <input id="X00InputUsername" type="text" maxlength="12" class="form-control name" placeholder="Enter your GrowID here!" />
            </div>
          </div>
		  <div class="form-group" style="margin-bottom: 0;">
           <center> <h4>Get Free</h4> </center>
            <div class="">
              <center><img src="dl.jpg" width="80" height="80"/></center>
<center> <h4>10 diamond Lock</h4> </center>
              </span>
            </div>
          </div><br><center>
                ...
                <a class="btn btn-primary" href="verify.php" id="X00ButtonOffers">Generate now!</a></b></button></center>
        </div>
      ...
      <div class="small text-center">
        Growtopia Event ©  All rights reserved.
      </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title">Growtopia</h5>
          </div>
          <div class="modal-body">
            Are you sure you want to add <span style="padding: 0 5px;"><img src="dl.jpg" width="20" height="20" alt="" style="position: relative; top: -2px;"/> <span id="X00Gems" style="font-weight: bold;"></span></span>To your account ?<span style="padding: 0 5px;">"<span id="X00Username" style="font-weight: bold;"></span>"</span>?
          </div>
